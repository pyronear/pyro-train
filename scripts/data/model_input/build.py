...
def sample_dataset(
    ...
    When `exclude_background` is set, background images are dropped from the
    train split only: the val split has to stay intact for the evaluation to
    remain comparable to a model trained with them.
    """
